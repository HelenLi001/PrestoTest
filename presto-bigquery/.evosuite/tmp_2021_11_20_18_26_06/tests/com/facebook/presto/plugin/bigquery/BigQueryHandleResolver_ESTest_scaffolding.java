...
public class BigQueryHandleResolver_ESTest_scaffolding {
  ...
  public static void initEvoSuiteFramework() { 
    org.evosuite.runtime.RuntimeSettings.className = "com.facebook.presto.plugin.bigquery.BigQueryHandleResolver"; 
  ...
  private static void initializeClasses() {
    org.evosuite.runtime.classhandling.ClassStateSupport.initializeClasses(BigQueryHandleResolver_ESTest_scaffolding.class.getClassLoader() ,
      ...
      "com.facebook.presto.plugin.bigquery.BigQueryHandleResolver",
      ...
      "com.facebook.presto.plugin.bigquery.BigQueryTransactionHandle",
  ...
  private static void resetClasses() {
    org.evosuite.runtime.classhandling.ClassResetter.getInstance().setClassLoader(BigQueryHandleResolver_ESTest_scaffolding.class.getClassLoader()); 
