...
public class BlackHoleHandleResolver_ESTest_scaffolding {
  ...
  public static void initEvoSuiteFramework() { 
    org.evosuite.runtime.RuntimeSettings.className = "com.facebook.presto.plugin.blackhole.BlackHoleHandleResolver"; 
  ...
  private static void initializeClasses() {
    org.evosuite.runtime.classhandling.ClassStateSupport.initializeClasses(BlackHoleHandleResolver_ESTest_scaffolding.class.getClassLoader() ,
      ...
      "com.facebook.presto.plugin.blackhole.BlackHoleInsertTableHandle",
      "com.facebook.presto.plugin.blackhole.BlackHoleHandleResolver"
    );
  } 

  private static void resetClasses() {
    org.evosuite.runtime.classhandling.ClassResetter.getInstance().setClassLoader(BlackHoleHandleResolver_ESTest_scaffolding.class.getClassLoader()); 
