...
public class DoWhileLoop_ESTest_scaffolding {
  ...
  public static void initEvoSuiteFramework() { 
    org.evosuite.runtime.RuntimeSettings.className = "com.facebook.presto.bytecode.control.DoWhileLoop"; 
  ...
  private static void initializeClasses() {
    org.evosuite.runtime.classhandling.ClassStateSupport.initializeClasses(DoWhileLoop_ESTest_scaffolding.class.getClassLoader() ,
  ...
  private static void initMocksToAvoidTimeoutsInTheTests() throws ClassNotFoundException { 
    mock(Class.forName("com.facebook.presto.bytecode.BytecodeVisitor", false, DoWhileLoop_ESTest_scaffolding.class.getClassLoader()));
    mock(Class.forName("com.facebook.presto.bytecode.MethodGenerationContext", false, DoWhileLoop_ESTest_scaffolding.class.getClassLoader()));
    mock(Class.forName("org.objectweb.asm.MethodVisitor", false, DoWhileLoop_ESTest_scaffolding.class.getClassLoader()));
  }

  private static void resetClasses() {
    org.evosuite.runtime.classhandling.ClassResetter.getInstance().setClassLoader(DoWhileLoop_ESTest_scaffolding.class.getClassLoader()); 
