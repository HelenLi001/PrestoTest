...
public class TryCatch_ESTest_scaffolding {
  ...
  public static void initEvoSuiteFramework() { 
    org.evosuite.runtime.RuntimeSettings.className = "com.facebook.presto.bytecode.control.TryCatch"; 
  ...
  private static void initializeClasses() {
    org.evosuite.runtime.classhandling.ClassStateSupport.initializeClasses(TryCatch_ESTest_scaffolding.class.getClassLoader() ,
  ...
  private static void initMocksToAvoidTimeoutsInTheTests() throws ClassNotFoundException { 
    mock(Class.forName("com.facebook.presto.bytecode.BytecodeNode", false, TryCatch_ESTest_scaffolding.class.getClassLoader()));
    mock(Class.forName("com.facebook.presto.bytecode.BytecodeVisitor", false, TryCatch_ESTest_scaffolding.class.getClassLoader()));
    mock(Class.forName("com.facebook.presto.bytecode.MethodGenerationContext", false, TryCatch_ESTest_scaffolding.class.getClassLoader()));
    mock(Class.forName("com.facebook.presto.bytecode.ParameterizedType", false, TryCatch_ESTest_scaffolding.class.getClassLoader()));
    mock(Class.forName("org.objectweb.asm.MethodVisitor", false, TryCatch_ESTest_scaffolding.class.getClassLoader()));
  }

  private static void resetClasses() {
    org.evosuite.runtime.classhandling.ClassResetter.getInstance().setClassLoader(TryCatch_ESTest_scaffolding.class.getClassLoader()); 
