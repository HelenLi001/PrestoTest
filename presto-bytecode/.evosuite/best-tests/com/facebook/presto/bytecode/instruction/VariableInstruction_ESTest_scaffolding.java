...
public class VariableInstruction_ESTest_scaffolding {
  ...
  public static void initEvoSuiteFramework() { 
    org.evosuite.runtime.RuntimeSettings.className = "com.facebook.presto.bytecode.instruction.VariableInstruction"; 
  ...
  private static void initializeClasses() {
    org.evosuite.runtime.classhandling.ClassStateSupport.initializeClasses(VariableInstruction_ESTest_scaffolding.class.getClassLoader() ,
  ...
  private static void initMocksToAvoidTimeoutsInTheTests() throws ClassNotFoundException { 
    mock(Class.forName("com.facebook.presto.bytecode.BytecodeVisitor", false, VariableInstruction_ESTest_scaffolding.class.getClassLoader()));
    mock(Class.forName("com.facebook.presto.bytecode.MethodGenerationContext", false, VariableInstruction_ESTest_scaffolding.class.getClassLoader()));
    mock(Class.forName("com.facebook.presto.bytecode.ParameterizedType", false, VariableInstruction_ESTest_scaffolding.class.getClassLoader()));
    mock(Class.forName("com.facebook.presto.bytecode.Variable", false, VariableInstruction_ESTest_scaffolding.class.getClassLoader()));
    mock(Class.forName("org.objectweb.asm.MethodVisitor", false, VariableInstruction_ESTest_scaffolding.class.getClassLoader()));
  }

  private static void resetClasses() {
    org.evosuite.runtime.classhandling.ClassResetter.getInstance().setClassLoader(VariableInstruction_ESTest_scaffolding.class.getClassLoader()); 
