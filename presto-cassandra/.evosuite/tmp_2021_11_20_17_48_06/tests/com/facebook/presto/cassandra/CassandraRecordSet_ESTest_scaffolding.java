...
public class CassandraRecordSet_ESTest_scaffolding {
  ...
  public static void initEvoSuiteFramework() { 
    org.evosuite.runtime.RuntimeSettings.className = "com.facebook.presto.cassandra.CassandraRecordSet"; 
  ...
  private static void initializeClasses() {
    org.evosuite.runtime.classhandling.ClassStateSupport.initializeClasses(CassandraRecordSet_ESTest_scaffolding.class.getClassLoader() ,
      "com.datastax.driver.core.TokenRange",
      "com.facebook.presto.spi.NotFoundException",
      "com.datastax.driver.core.RegularStatement",
      "com.facebook.presto.cassandra.CassandraRecordSet",
  ...
  private static void initMocksToAvoidTimeoutsInTheTests() throws ClassNotFoundException { 
    mock(Class.forName("com.facebook.presto.cassandra.CassandraSession", false, CassandraRecordSet_ESTest_scaffolding.class.getClassLoader()));
  }

  private static void resetClasses() {
    org.evosuite.runtime.classhandling.ClassResetter.getInstance().setClassLoader(CassandraRecordSet_ESTest_scaffolding.class.getClassLoader()); 
