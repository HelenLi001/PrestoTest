...
public class ZipIndexFileSource_ESTest_scaffolding {
  ...
  public static void initEvoSuiteFramework() { 
    org.evosuite.runtime.RuntimeSettings.className = "com.facebook.presto.druid.segment.ZipIndexFileSource"; 
  ...
  private static void initializeClasses() {
    org.evosuite.runtime.classhandling.ClassStateSupport.initializeClasses(ZipIndexFileSource_ESTest_scaffolding.class.getClassLoader() ,
      "com.facebook.presto.druid.zip.ExtraDataList",
      "com.facebook.presto.druid.DataInputSourceId",
      "com.facebook.presto.druid.segment.ZipIndexFileSource",
  ...
  private static void resetClasses() {
    org.evosuite.runtime.classhandling.ClassResetter.getInstance().setClassLoader(ZipIndexFileSource_ESTest_scaffolding.class.getClassLoader()); 
