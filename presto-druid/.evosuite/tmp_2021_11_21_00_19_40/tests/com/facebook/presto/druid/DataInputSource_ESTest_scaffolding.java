...
public class DataInputSource_ESTest_scaffolding {
  ...
  public static void initEvoSuiteFramework() { 
    org.evosuite.runtime.RuntimeSettings.className = "com.facebook.presto.druid.DataInputSource"; 
  ...
  private static void initializeClasses() {
    org.evosuite.runtime.classhandling.ClassStateSupport.initializeClasses(DataInputSource_ESTest_scaffolding.class.getClassLoader() ,
      ...
      "com.facebook.presto.druid.segment.HdfsDataInputSource",
      "org.apache.hadoop.fs.FSDataInputStream",
      "org.apache.hadoop.classification.InterfaceStability$Stable"
    );
  } 
  private static void initMocksToAvoidTimeoutsInTheTests() throws ClassNotFoundException { 
    mock(Class.forName("com.facebook.presto.druid.DataInputSourceId", false, DataInputSource_ESTest_scaffolding.class.getClassLoader()));
    mock(Class.forName("org.apache.hadoop.fs.FSDataInputStream", false, DataInputSource_ESTest_scaffolding.class.getClassLoader()));
  }

  private static void resetClasses() {
    org.evosuite.runtime.classhandling.ClassResetter.getInstance().setClassLoader(DataInputSource_ESTest_scaffolding.class.getClassLoader()); 
