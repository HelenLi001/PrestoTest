...
public class SqlFunctionIdArgumentFactory_ESTest_scaffolding {
  ...
  public static void initEvoSuiteFramework() { 
    org.evosuite.runtime.RuntimeSettings.className = "com.facebook.presto.functionNamespace.mysql.SqlFunctionIdArgumentFactory"; 
  ...
  private static void initializeClasses() {
    org.evosuite.runtime.classhandling.ClassStateSupport.initializeClasses(SqlFunctionIdArgumentFactory_ESTest_scaffolding.class.getClassLoader() ,
  ...
  private static void initMocksToAvoidTimeoutsInTheTests() throws ClassNotFoundException { 
    mock(Class.forName("com.facebook.presto.spi.function.SqlFunctionId", false, SqlFunctionIdArgumentFactory_ESTest_scaffolding.class.getClassLoader()));
    mock(Class.forName("org.jdbi.v3.core.config.ConfigRegistry", false, SqlFunctionIdArgumentFactory_ESTest_scaffolding.class.getClassLoader()));
  }

  private static void resetClasses() {
    org.evosuite.runtime.classhandling.ClassResetter.getInstance().setClassLoader(SqlFunctionIdArgumentFactory_ESTest_scaffolding.class.getClassLoader()); 
