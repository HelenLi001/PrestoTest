...
public class SqlInvokedFunctionRecordRowMapper_ESTest_scaffolding {
  ...
  public static void initEvoSuiteFramework() { 
    org.evosuite.runtime.RuntimeSettings.className = "com.facebook.presto.functionNamespace.mysql.SqlInvokedFunctionRecordRowMapper"; 
  ...
  private static void initializeClasses() {
    org.evosuite.runtime.classhandling.ClassStateSupport.initializeClasses(SqlInvokedFunctionRecordRowMapper_ESTest_scaffolding.class.getClassLoader() ,
  ...
  private static void initMocksToAvoidTimeoutsInTheTests() throws ClassNotFoundException { 
    mock(Class.forName("java.sql.ResultSet", false, SqlInvokedFunctionRecordRowMapper_ESTest_scaffolding.class.getClassLoader()));
    mock(Class.forName("org.jdbi.v3.core.statement.StatementContext", false, SqlInvokedFunctionRecordRowMapper_ESTest_scaffolding.class.getClassLoader()));
  }

  private static void resetClasses() {
    org.evosuite.runtime.classhandling.ClassResetter.getInstance().setClassLoader(SqlInvokedFunctionRecordRowMapper_ESTest_scaffolding.class.getClassLoader()); 
