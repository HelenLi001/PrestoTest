...
public class BingTileFunctions_ESTest_scaffolding {
  ...
  public static void initEvoSuiteFramework() { 
    org.evosuite.runtime.RuntimeSettings.className = "com.facebook.presto.plugin.geospatial.BingTileFunctions"; 
  ...
  private static void initializeClasses() {
    org.evosuite.runtime.classhandling.ClassStateSupport.initializeClasses(BingTileFunctions_ESTest_scaffolding.class.getClassLoader() ,
      ...
      "com.facebook.presto.plugin.geospatial.BingTileFunctions",
  ...
  private static void resetClasses() {
    org.evosuite.runtime.classhandling.ClassResetter.getInstance().setClassLoader(BingTileFunctions_ESTest_scaffolding.class.getClassLoader()); 
