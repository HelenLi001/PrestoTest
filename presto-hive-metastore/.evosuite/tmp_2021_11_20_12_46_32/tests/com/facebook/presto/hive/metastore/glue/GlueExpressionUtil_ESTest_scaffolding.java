...
public class GlueExpressionUtil_ESTest_scaffolding {
  ...
  public static void initEvoSuiteFramework() { 
    org.evosuite.runtime.RuntimeSettings.className = "com.facebook.presto.hive.metastore.glue.GlueExpressionUtil"; 
  ...
  private static void initializeClasses() {
    org.evosuite.runtime.classhandling.ClassStateSupport.initializeClasses(GlueExpressionUtil_ESTest_scaffolding.class.getClassLoader() ,
      ...
      "com.facebook.presto.hive.metastore.glue.GlueExpressionUtil",
  ...
  private static void resetClasses() {
    org.evosuite.runtime.classhandling.ClassResetter.getInstance().setClassLoader(GlueExpressionUtil_ESTest_scaffolding.class.getClassLoader()); 
