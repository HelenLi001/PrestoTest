...
public class OracleClient_ESTest_scaffolding {
  ...
  public static void initEvoSuiteFramework() { 
    org.evosuite.runtime.RuntimeSettings.className = "com.facebook.presto.plugin.oracle.OracleClient"; 
  ...
  private static void initializeClasses() {
    org.evosuite.runtime.classhandling.ClassStateSupport.initializeClasses(OracleClient_ESTest_scaffolding.class.getClassLoader() ,
      ...
      "com.facebook.presto.plugin.oracle.OracleClient",
  ...
  private static void resetClasses() {
    org.evosuite.runtime.classhandling.ClassResetter.getInstance().setClassLoader(OracleClient_ESTest_scaffolding.class.getClassLoader()); 
