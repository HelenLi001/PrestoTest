...
public class StorageOrcFileTailSource_ESTest_scaffolding {
  ...
  public static void initEvoSuiteFramework() { 
    org.evosuite.runtime.RuntimeSettings.className = "com.facebook.presto.orc.cache.StorageOrcFileTailSource"; 
  ...
  private static void initializeClasses() {
    org.evosuite.runtime.classhandling.ClassStateSupport.initializeClasses(StorageOrcFileTailSource_ESTest_scaffolding.class.getClassLoader() ,
      "com.facebook.presto.orc.cache.StorageOrcFileTailSource",
  ...
  private static void resetClasses() {
    org.evosuite.runtime.classhandling.ClassResetter.getInstance().setClassLoader(StorageOrcFileTailSource_ESTest_scaffolding.class.getClassLoader()); 
