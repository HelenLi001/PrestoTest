...
public class FloatBatchStreamReader_ESTest_scaffolding {
  ...
  public static void initEvoSuiteFramework() { 
    org.evosuite.runtime.RuntimeSettings.className = "com.facebook.presto.orc.reader.FloatBatchStreamReader"; 
  ...
  private static void initializeClasses() {
    org.evosuite.runtime.classhandling.ClassStateSupport.initializeClasses(FloatBatchStreamReader_ESTest_scaffolding.class.getClassLoader() ,
      ...
      "com.facebook.presto.orc.reader.FloatBatchStreamReader",
  ...
  private static void resetClasses() {
    org.evosuite.runtime.classhandling.ClassResetter.getInstance().setClassLoader(FloatBatchStreamReader_ESTest_scaffolding.class.getClassLoader()); 
