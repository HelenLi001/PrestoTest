...
public class LongDecimalSelectiveStreamReader_ESTest_scaffolding {
  ...
  public static void initEvoSuiteFramework() { 
    org.evosuite.runtime.RuntimeSettings.className = "com.facebook.presto.orc.reader.LongDecimalSelectiveStreamReader"; 
  ...
  private static void initializeClasses() {
    org.evosuite.runtime.classhandling.ClassStateSupport.initializeClasses(LongDecimalSelectiveStreamReader_ESTest_scaffolding.class.getClassLoader() ,
      "com.facebook.presto.orc.reader.LongDecimalSelectiveStreamReader",
  ...
  private static void resetClasses() {
    org.evosuite.runtime.classhandling.ClassResetter.getInstance().setClassLoader(LongDecimalSelectiveStreamReader_ESTest_scaffolding.class.getClassLoader()); 
