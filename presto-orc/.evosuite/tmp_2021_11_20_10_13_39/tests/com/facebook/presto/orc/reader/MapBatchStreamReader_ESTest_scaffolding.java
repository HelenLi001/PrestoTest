...
public class MapBatchStreamReader_ESTest_scaffolding {
  ...
  public static void initEvoSuiteFramework() { 
    org.evosuite.runtime.RuntimeSettings.className = "com.facebook.presto.orc.reader.MapBatchStreamReader"; 
  ...
  private static void initializeClasses() {
    org.evosuite.runtime.classhandling.ClassStateSupport.initializeClasses(MapBatchStreamReader_ESTest_scaffolding.class.getClassLoader() ,
      ...
      "com.facebook.presto.orc.reader.MapBatchStreamReader",
      "org.openjdk.jol.util.VMSupport$MyFloats4",
      "org.openjdk.jol.util.VMSupport$MyDoubles4",
      "com.facebook.presto.orc.reader.MapFlatBatchStreamReader",
  ...
  private static void resetClasses() {
    org.evosuite.runtime.classhandling.ClassResetter.getInstance().setClassLoader(MapBatchStreamReader_ESTest_scaffolding.class.getClassLoader()); 
