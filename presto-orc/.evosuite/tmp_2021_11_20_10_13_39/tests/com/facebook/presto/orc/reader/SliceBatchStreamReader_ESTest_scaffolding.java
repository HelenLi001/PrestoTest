...
public class SliceBatchStreamReader_ESTest_scaffolding {
  ...
  public static void initEvoSuiteFramework() { 
    org.evosuite.runtime.RuntimeSettings.className = "com.facebook.presto.orc.reader.SliceBatchStreamReader"; 
  ...
  private static void initializeClasses() {
    org.evosuite.runtime.classhandling.ClassStateSupport.initializeClasses(SliceBatchStreamReader_ESTest_scaffolding.class.getClassLoader() ,
      ...
      "com.facebook.presto.orc.reader.SliceBatchStreamReader",
  ...
  private static void resetClasses() {
    org.evosuite.runtime.classhandling.ClassResetter.getInstance().setClassLoader(SliceBatchStreamReader_ESTest_scaffolding.class.getClassLoader()); 
