...
public class SliceDirectBatchStreamReader_ESTest_scaffolding {
  ...
  public static void initEvoSuiteFramework() { 
    org.evosuite.runtime.RuntimeSettings.className = "com.facebook.presto.orc.reader.SliceDirectBatchStreamReader"; 
  ...
  private static void initializeClasses() {
    org.evosuite.runtime.classhandling.ClassStateSupport.initializeClasses(SliceDirectBatchStreamReader_ESTest_scaffolding.class.getClassLoader() ,
      ...
      "com.facebook.presto.orc.reader.SliceDirectBatchStreamReader",
  ...
  private static void resetClasses() {
    org.evosuite.runtime.classhandling.ClassResetter.getInstance().setClassLoader(SliceDirectBatchStreamReader_ESTest_scaffolding.class.getClassLoader()); 
