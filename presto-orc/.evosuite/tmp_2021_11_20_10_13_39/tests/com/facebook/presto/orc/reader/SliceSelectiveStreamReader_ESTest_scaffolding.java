...
public class SliceSelectiveStreamReader_ESTest_scaffolding {
  ...
  public static void initEvoSuiteFramework() { 
    org.evosuite.runtime.RuntimeSettings.className = "com.facebook.presto.orc.reader.SliceSelectiveStreamReader"; 
  ...
  private static void initializeClasses() {
    org.evosuite.runtime.classhandling.ClassStateSupport.initializeClasses(SliceSelectiveStreamReader_ESTest_scaffolding.class.getClassLoader() ,
      ...
      "com.facebook.presto.orc.reader.SliceSelectiveStreamReader",
  ...
  private static void resetClasses() {
    org.evosuite.runtime.classhandling.ClassResetter.getInstance().setClassLoader(SliceSelectiveStreamReader_ESTest_scaffolding.class.getClassLoader()); 
