...
public class StructSelectiveStreamReader_ESTest_scaffolding {
  ...
  public static void initEvoSuiteFramework() { 
    org.evosuite.runtime.RuntimeSettings.className = "com.facebook.presto.orc.reader.StructSelectiveStreamReader"; 
  ...
  private static void initializeClasses() {
    org.evosuite.runtime.classhandling.ClassStateSupport.initializeClasses(StructSelectiveStreamReader_ESTest_scaffolding.class.getClassLoader() ,
      "com.facebook.presto.orc.StreamDescriptor",
      "org.openjdk.jol.util.VMSupport$MyBooleans4",
      "com.facebook.presto.orc.reader.StructSelectiveStreamReader",
  ...
  private static void resetClasses() {
    org.evosuite.runtime.classhandling.ClassResetter.getInstance().setClassLoader(StructSelectiveStreamReader_ESTest_scaffolding.class.getClassLoader()); 
