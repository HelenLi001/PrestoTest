...
public class LongOutputStreamV1_ESTest_scaffolding {
  ...
  public static void initEvoSuiteFramework() { 
    org.evosuite.runtime.RuntimeSettings.className = "com.facebook.presto.orc.stream.LongOutputStreamV1"; 
  ...
  private static void initializeClasses() {
    org.evosuite.runtime.classhandling.ClassStateSupport.initializeClasses(LongOutputStreamV1_ESTest_scaffolding.class.getClassLoader() ,
      ...
      "com.facebook.presto.orc.stream.LongOutputStreamV1",
  ...
  private static void resetClasses() {
    org.evosuite.runtime.classhandling.ClassResetter.getInstance().setClassLoader(LongOutputStreamV1_ESTest_scaffolding.class.getClassLoader()); 
