...
public class DoubleColumnWriter_ESTest_scaffolding {
  ...
  public static void initEvoSuiteFramework() { 
    org.evosuite.runtime.RuntimeSettings.className = "com.facebook.presto.orc.writer.DoubleColumnWriter"; 
  ...
  private static void initializeClasses() {
    org.evosuite.runtime.classhandling.ClassStateSupport.initializeClasses(DoubleColumnWriter_ESTest_scaffolding.class.getClassLoader() ,
      "org.openjdk.jol.util.VMSupport$MyBooleans4",
      "org.openjdk.jol.util.VMSupport$VMOptions",
      "com.facebook.presto.orc.writer.DoubleColumnWriter",
      ...
      "com.facebook.presto.orc.metadata.statistics.DoubleStatisticsBuilder",
  ...
  private static void resetClasses() {
    org.evosuite.runtime.classhandling.ClassResetter.getInstance().setClassLoader(DoubleColumnWriter_ESTest_scaffolding.class.getClassLoader()); 
