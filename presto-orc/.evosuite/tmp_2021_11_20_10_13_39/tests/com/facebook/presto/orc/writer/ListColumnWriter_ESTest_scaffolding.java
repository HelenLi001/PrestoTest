...
public class ListColumnWriter_ESTest_scaffolding {
  ...
  public static void initEvoSuiteFramework() { 
    org.evosuite.runtime.RuntimeSettings.className = "com.facebook.presto.orc.writer.ListColumnWriter"; 
  ...
  private static void initializeClasses() {
    org.evosuite.runtime.classhandling.ClassStateSupport.initializeClasses(ListColumnWriter_ESTest_scaffolding.class.getClassLoader() ,
      ...
      "com.facebook.presto.orc.writer.ListColumnWriter",
  ...
  private static void resetClasses() {
    org.evosuite.runtime.classhandling.ClassResetter.getInstance().setClassLoader(ListColumnWriter_ESTest_scaffolding.class.getClassLoader()); 
