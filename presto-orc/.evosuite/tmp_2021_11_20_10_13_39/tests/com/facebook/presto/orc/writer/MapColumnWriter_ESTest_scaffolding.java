...
public class MapColumnWriter_ESTest_scaffolding {
  ...
  public static void initEvoSuiteFramework() { 
    org.evosuite.runtime.RuntimeSettings.className = "com.facebook.presto.orc.writer.MapColumnWriter"; 
  ...
  private static void initializeClasses() {
    org.evosuite.runtime.classhandling.ClassStateSupport.initializeClasses(MapColumnWriter_ESTest_scaffolding.class.getClassLoader() ,
      "org.openjdk.jol.util.VMSupport$MyBooleans4",
      "org.openjdk.jol.util.VMSupport$VMOptions",
      "com.facebook.presto.orc.writer.MapColumnWriter",
  ...
  private static void resetClasses() {
    org.evosuite.runtime.classhandling.ClassResetter.getInstance().setClassLoader(MapColumnWriter_ESTest_scaffolding.class.getClassLoader()); 
