...
public class TimestampColumnWriter_ESTest_scaffolding {
  ...
  public static void initEvoSuiteFramework() { 
    org.evosuite.runtime.RuntimeSettings.className = "com.facebook.presto.orc.writer.TimestampColumnWriter"; 
  ...
  private static void initializeClasses() {
    org.evosuite.runtime.classhandling.ClassStateSupport.initializeClasses(TimestampColumnWriter_ESTest_scaffolding.class.getClassLoader() ,
      ...
      "com.facebook.presto.orc.writer.TimestampColumnWriter",
  ...
  private static void resetClasses() {
    org.evosuite.runtime.classhandling.ClassResetter.getInstance().setClassLoader(TimestampColumnWriter_ESTest_scaffolding.class.getClassLoader()); 
