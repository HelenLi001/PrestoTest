...
public class MetadataReader_ESTest_scaffolding {
  ...
  public static void initEvoSuiteFramework() { 
    org.evosuite.runtime.RuntimeSettings.className = "com.facebook.presto.parquet.cache.MetadataReader"; 
  ...
  private static void initializeClasses() {
    org.evosuite.runtime.classhandling.ClassStateSupport.initializeClasses(MetadataReader_ESTest_scaffolding.class.getClassLoader() ,
      "com.facebook.presto.parquet.cache.MetadataReader",
  ...
  private static void resetClasses() {
    org.evosuite.runtime.classhandling.ClassResetter.getInstance().setClassLoader(MetadataReader_ESTest_scaffolding.class.getClassLoader()); 
