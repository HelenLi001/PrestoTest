...
public class PostgreSqlClient_ESTest_scaffolding {
  ...
  public static void initEvoSuiteFramework() { 
    org.evosuite.runtime.RuntimeSettings.className = "com.facebook.presto.plugin.postgresql.PostgreSqlClient"; 
  ...
  private static void initializeClasses() {
    org.evosuite.runtime.classhandling.ClassStateSupport.initializeClasses(PostgreSqlClient_ESTest_scaffolding.class.getClassLoader() ,
      ...
      "com.facebook.presto.plugin.postgresql.PostgreSqlClient",
  ...
  private static void resetClasses() {
    org.evosuite.runtime.classhandling.ClassResetter.getInstance().setClassLoader(PostgreSqlClient_ESTest_scaffolding.class.getClassLoader()); 
