...
public class DecimalEncoding_ESTest_scaffolding {
  ...
  public static void initEvoSuiteFramework() { 
    org.evosuite.runtime.RuntimeSettings.className = "com.facebook.presto.rcfile.text.DecimalEncoding"; 
  ...
  private static void initializeClasses() {
    org.evosuite.runtime.classhandling.ClassStateSupport.initializeClasses(DecimalEncoding_ESTest_scaffolding.class.getClassLoader() ,
      ...
      "com.facebook.presto.rcfile.text.DecimalEncoding",
  ...
  private static void initMocksToAvoidTimeoutsInTheTests() throws ClassNotFoundException { 
    mock(Class.forName("com.facebook.presto.common.block.BlockBuilder", false, DecimalEncoding_ESTest_scaffolding.class.getClassLoader()));
    mock(Class.forName("com.facebook.presto.common.type.Type", false, DecimalEncoding_ESTest_scaffolding.class.getClassLoader()));
    mock(Class.forName("com.facebook.presto.rcfile.ColumnData", false, DecimalEncoding_ESTest_scaffolding.class.getClassLoader()));
    mock(Class.forName("com.facebook.presto.rcfile.EncodeOutput", false, DecimalEncoding_ESTest_scaffolding.class.getClassLoader()));
    mock(Class.forName("io.airlift.slice.SliceOutput", false, DecimalEncoding_ESTest_scaffolding.class.getClassLoader()));
  }

  private static void resetClasses() {
    org.evosuite.runtime.classhandling.ClassResetter.getInstance().setClassLoader(DecimalEncoding_ESTest_scaffolding.class.getClassLoader()); 
