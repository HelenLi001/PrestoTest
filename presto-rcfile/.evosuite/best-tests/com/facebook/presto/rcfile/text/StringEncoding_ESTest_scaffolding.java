...
public class StringEncoding_ESTest_scaffolding {
  ...
  public static void initEvoSuiteFramework() { 
    org.evosuite.runtime.RuntimeSettings.className = "com.facebook.presto.rcfile.text.StringEncoding"; 
  ...
  private static void initializeClasses() {
    org.evosuite.runtime.classhandling.ClassStateSupport.initializeClasses(StringEncoding_ESTest_scaffolding.class.getClassLoader() ,
      ...
      "com.facebook.presto.rcfile.text.StringEncoding",
  ...
  private static void initMocksToAvoidTimeoutsInTheTests() throws ClassNotFoundException { 
    mock(Class.forName("com.facebook.presto.common.block.Block", false, StringEncoding_ESTest_scaffolding.class.getClassLoader()));
    mock(Class.forName("com.facebook.presto.common.block.BlockBuilder", false, StringEncoding_ESTest_scaffolding.class.getClassLoader()));
    mock(Class.forName("com.facebook.presto.common.type.Type", false, StringEncoding_ESTest_scaffolding.class.getClassLoader()));
    mock(Class.forName("com.facebook.presto.rcfile.ColumnData", false, StringEncoding_ESTest_scaffolding.class.getClassLoader()));
    mock(Class.forName("com.facebook.presto.rcfile.EncodeOutput", false, StringEncoding_ESTest_scaffolding.class.getClassLoader()));
    mock(Class.forName("io.airlift.slice.Slice", false, StringEncoding_ESTest_scaffolding.class.getClassLoader()));
    mock(Class.forName("io.airlift.slice.SliceOutput", false, StringEncoding_ESTest_scaffolding.class.getClassLoader()));
  }

  private static void resetClasses() {
    org.evosuite.runtime.classhandling.ClassResetter.getInstance().setClassLoader(StringEncoding_ESTest_scaffolding.class.getClassLoader()); 
