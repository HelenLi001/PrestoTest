...
public class BufferedOutputStreamSliceOutput_ESTest_scaffolding {
  ...
  public static void initEvoSuiteFramework() { 
    org.evosuite.runtime.RuntimeSettings.className = "com.facebook.presto.rcfile.BufferedOutputStreamSliceOutput"; 
  ...
  private static void initializeClasses() {
    org.evosuite.runtime.classhandling.ClassStateSupport.initializeClasses(BufferedOutputStreamSliceOutput_ESTest_scaffolding.class.getClassLoader() ,
  ...
  private static void resetClasses() {
    org.evosuite.runtime.classhandling.ClassResetter.getInstance().setClassLoader(BufferedOutputStreamSliceOutput_ESTest_scaffolding.class.getClassLoader()); 
