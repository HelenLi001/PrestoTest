...
public class RcFileReader_ESTest_scaffolding {
  ...
  public static void initEvoSuiteFramework() { 
    org.evosuite.runtime.RuntimeSettings.className = "com.facebook.presto.rcfile.RcFileReader"; 
  ...
  private static void initializeClasses() {
    org.evosuite.runtime.classhandling.ClassStateSupport.initializeClasses(RcFileReader_ESTest_scaffolding.class.getClassLoader() ,
      ...
      "com.facebook.presto.rcfile.RcFileReader",
  ...
  private static void resetClasses() {
    org.evosuite.runtime.classhandling.ClassResetter.getInstance().setClassLoader(RcFileReader_ESTest_scaffolding.class.getClassLoader()); 
