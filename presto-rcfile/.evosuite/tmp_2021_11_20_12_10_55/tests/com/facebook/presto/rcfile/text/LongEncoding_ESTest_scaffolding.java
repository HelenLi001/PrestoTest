...
public class LongEncoding_ESTest_scaffolding {
  ...
  public static void initEvoSuiteFramework() { 
    org.evosuite.runtime.RuntimeSettings.className = "com.facebook.presto.rcfile.text.LongEncoding"; 
  ...
  private static void initializeClasses() {
    org.evosuite.runtime.classhandling.ClassStateSupport.initializeClasses(LongEncoding_ESTest_scaffolding.class.getClassLoader() ,
      ...
      "com.facebook.presto.rcfile.text.LongEncoding",
  ...
  private static void resetClasses() {
    org.evosuite.runtime.classhandling.ClassResetter.getInstance().setClassLoader(LongEncoding_ESTest_scaffolding.class.getClassLoader()); 
