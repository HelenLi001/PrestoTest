...
public class TextRcFileEncoding_ESTest_scaffolding {
  ...
  public static void initEvoSuiteFramework() { 
    org.evosuite.runtime.RuntimeSettings.className = "com.facebook.presto.rcfile.text.TextRcFileEncoding"; 
  ...
  private static void initializeClasses() {
    org.evosuite.runtime.classhandling.ClassStateSupport.initializeClasses(TextRcFileEncoding_ESTest_scaffolding.class.getClassLoader() ,
      ...
      "com.facebook.presto.rcfile.text.TextRcFileEncoding",
  ...
  private static void resetClasses() {
    org.evosuite.runtime.classhandling.ClassResetter.getInstance().setClassLoader(TextRcFileEncoding_ESTest_scaffolding.class.getClassLoader()); 
