...
public class ResourceGroupIdTemplate_ESTest_scaffolding {
  ...
  public static void initEvoSuiteFramework() { 
    org.evosuite.runtime.RuntimeSettings.className = "com.facebook.presto.resourceGroups.ResourceGroupIdTemplate"; 
  ...
  private static void initializeClasses() {
    org.evosuite.runtime.classhandling.ClassStateSupport.initializeClasses(ResourceGroupIdTemplate_ESTest_scaffolding.class.getClassLoader() ,
      ...
      "com.facebook.presto.resourceGroups.ResourceGroupIdTemplate",
  ...
  private static void resetClasses() {
    org.evosuite.runtime.classhandling.ClassResetter.getInstance().setClassLoader(ResourceGroupIdTemplate_ESTest_scaffolding.class.getClassLoader()); 
