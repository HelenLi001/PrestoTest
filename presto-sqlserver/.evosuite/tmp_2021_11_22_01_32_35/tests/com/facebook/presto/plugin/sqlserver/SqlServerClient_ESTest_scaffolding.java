...
public class SqlServerClient_ESTest_scaffolding {
  ...
  public static void initEvoSuiteFramework() { 
    org.evosuite.runtime.RuntimeSettings.className = "com.facebook.presto.plugin.sqlserver.SqlServerClient"; 
  ...
  private static void initializeClasses() {
    org.evosuite.runtime.classhandling.ClassStateSupport.initializeClasses(SqlServerClient_ESTest_scaffolding.class.getClassLoader() ,
      ...
      "com.facebook.presto.plugin.sqlserver.SqlServerClient",
  ...
  private static void resetClasses() {
    org.evosuite.runtime.classhandling.ClassResetter.getInstance().setClassLoader(SqlServerClient_ESTest_scaffolding.class.getClassLoader()); 
