...
public class TupleDomainConversion_ESTest_scaffolding {
  ...
  public static void initEvoSuiteFramework() { 
    org.evosuite.runtime.RuntimeSettings.className = "com.facebook.presto.connector.thrift.util.TupleDomainConversion"; 
  ...
  private static void initializeClasses() {
    org.evosuite.runtime.classhandling.ClassStateSupport.initializeClasses(TupleDomainConversion_ESTest_scaffolding.class.getClassLoader() ,
      "com.facebook.presto.connector.thrift.util.TupleDomainConversion",
  ...
  private static void resetClasses() {
    org.evosuite.runtime.classhandling.ClassResetter.getInstance().setClassLoader(TupleDomainConversion_ESTest_scaffolding.class.getClassLoader()); 
