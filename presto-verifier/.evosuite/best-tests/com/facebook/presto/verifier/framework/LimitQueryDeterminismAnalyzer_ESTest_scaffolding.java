...
public class LimitQueryDeterminismAnalyzer_ESTest_scaffolding {
  ...
  public static void initEvoSuiteFramework() { 
    org.evosuite.runtime.RuntimeSettings.className = "com.facebook.presto.verifier.framework.LimitQueryDeterminismAnalyzer"; 
  ...
  private static void initializeClasses() {
    org.evosuite.runtime.classhandling.ClassStateSupport.initializeClasses(LimitQueryDeterminismAnalyzer_ESTest_scaffolding.class.getClassLoader() ,
      "com.facebook.presto.verifier.event.DeterminismAnalysisDetails$1",
      "com.facebook.presto.verifier.framework.LimitQueryDeterminismAnalyzer$ColumnNameOrIndex",
      ...
      "com.facebook.presto.verifier.event.DeterminismAnalysisRun",
  ...
  private static void initMocksToAvoidTimeoutsInTheTests() throws ClassNotFoundException { 
    mock(Class.forName("com.facebook.presto.sql.tree.Statement", false, LimitQueryDeterminismAnalyzer_ESTest_scaffolding.class.getClassLoader()));
    mock(Class.forName("com.facebook.presto.verifier.event.DeterminismAnalysisDetails$Builder", false, LimitQueryDeterminismAnalyzer_ESTest_scaffolding.class.getClassLoader()));
    mock(Class.forName("com.facebook.presto.verifier.prestoaction.PrestoAction", false, LimitQueryDeterminismAnalyzer_ESTest_scaffolding.class.getClassLoader()));
  }

  private static void resetClasses() {
    org.evosuite.runtime.classhandling.ClassResetter.getInstance().setClassLoader(LimitQueryDeterminismAnalyzer_ESTest_scaffolding.class.getClassLoader()); 

    org.evosuite.runtime.classhandling.ClassStateSupport.resetClasses(
      "com.facebook.presto.verifier.framework.LimitQueryDeterminismAnalyzer",
      "com.facebook.presto.verifier.framework.LimitQueryDeterminismAnalyzer$ColumnNameOrIndex",
      "com.facebook.presto.verifier.framework.LimitQueryDeterminismAnalyzer$TieInspector",
      "com.facebook.presto.verifier.framework.LimitQueryDeterminismAnalysis",
